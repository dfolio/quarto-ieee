...
The `quarto-ieee` template relies mainly on the Markdown markup supported by Quarto @quarto-markdonw, which is build based on Pandoc [@MacFarlane_Pandoc; @Allaire_Quarto_2022].
